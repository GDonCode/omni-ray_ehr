...
export default function NewAppointment() {
  ...
  // Validation (DOB removed)
  const validatePersonalInfo = () => {
    const errors: string[] = [];
    const { firstName, lastName, appointmentFor, guardianFirstName, guardianLastName, email, phone, terms } = bookingData.personalInfo;
  ...
  const isPersonalInfoComplete = () => {
    const { firstName, lastName, email, phone, contactMethod, terms } = bookingData.personalInfo;
    return !!(
      firstName.trim() &&
      lastName.trim() &&
      email.trim() &&
