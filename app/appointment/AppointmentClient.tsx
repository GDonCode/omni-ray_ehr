    ...
    {/* FOOTER */}
        <div className="relative bg-[#004c4c] p-8 lg:p-12 border-t-4 border-[#004c4c] lg:mt-12">
                      <div className="flex flex-col lg:flex-row lg:justify-between">
                        <div className="">
                          <h4 className={`${tt_wellingtons.className} text-gray-100 text-xl font-semibold border-b border-[#f6d212] w-fit pb-1 mb-6`}>Contact Us</h4>
                        ...
                        <div className="mt-12 lg:mt-0">
                          <h4 className={`${tt_wellingtons.className} text-gray-100 text-xl font-semibold border-b border-[#f6d212] w-fit pb-1 mb-6`}>Opening Hours</h4>
                        ...
                        <div className="mt-12 lg:mt-0">
                          <h4 className={`${tt_wellingtons.className} text-gray-100 text-xl font-semibold border-b border-[#f6d212] w-fit pb-1 mb-4`}>Quick Links</h4>
                        ...
                        <div className="mt-12 lg:mt-0">
                          <h4 className={`${tt_wellingtons.className} text-gray-100 text-xl font-semibold border-b border-[#f6d212] w-fit pb-1 mb-4`}>Our Services</h4>
